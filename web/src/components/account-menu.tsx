  ...
  return (
    <details className="group relative">
      <summary
        ...
        className="grid h-[27px] w-[27px] cursor-pointer list-none place-items-center rounded-full border border-rule-strong bg-raise font-mono text-[10.5px] text-graphite transition-colors hover:border-marker-line hover:text-bone [&::-webkit-details-marker]:hidden"
      >
        SH
      </summary>

      <div className="absolute top-[calc(100%+8px)] right-0 z-50 w-[150px] rounded-[3px] border border-rule-strong bg-chrome p-1.5 shadow-[0_16px_40px_rgba(0,0,0,0.45)]">
